...
function Location() {
    ...
    const goToLocationOnMap = () => {
        const address = encodeURIComponent("CLOUD-9 VILLAS, Electronic City, Bengaluru, Bommasandra, Karnataka 560099, India");
        ...
        <div className={styles.LocationWrap}>
            ...
            <div className={styles.LocationContainer}>
                ...
                <div className={styles.LocationRight}>
                    <p>Phone: +91 99008 47847</p>
                    <h3>5-Minute Drive From Electronic City.</h3>
                </div>
            </div>
            <div className={styles.flexContainer}>
                {LocationData.map((item) => (
                    <div className={styles.flexItem} onClick={goToLocationOnMap}>
